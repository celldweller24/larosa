...
return [
    ...
    'sidebar' => [
        ...
        'menu' => [
            ...
            'relaxating-massage' => 'Relaxating massage',
            'hawaiian-massage' => 'Hawaiian massage',
            'royal-vip-massage' => 'Royal VIP massage',
            'nuru-massage' => 'Nuru VIP massage',
            'escort-service' => 'Escort service',
            'hotel-service' => 'Hotel service',
            'secret-wish' => 'Secret wish',
            'swingers-massage' => 'Swingers massage',
        ],
    ...
    'home' => [
        ...
        'meta-keywords' => 'erotic massage Prague, czech massage',
        'meta-description' => 'Our erotic massage in Prague will evoke the sexual fire inside you, with the tantric massages you will experience a climax in every part of your body.',
    ],
    ...
    'pricing' => [
        ...
        'relaxating-massage' => 'Relaxating massage',
        'hawaiian-massage' => 'Hawaiian massage (lomi lomi)',
        'royal-vip-massage' => 'Royal VIP massage',
        'nuru-massage' => 'Nuru massage',
        'swingers-massage' => 'Swingers massage',
        'secret-massage' => 'Secret massage',
        ...
        'meta-title' => 'Erotic Massage Prague | Massage Price',
        'meta-keywords' => 'Erotic massage price.',
        'meta-description' => 'Erotig massage price Larosa.cz',
    ],

    /** Photo gallery page */
    'photo_gallery' => [
        'title' => 'Photo gallery',
        'description' => 'You are attractive, communicative lady and would like to apply for position of erotic masseuse? We are hiring! Contact us via e-mail for the details.',
        'meta-title' => 'Erotic Massage Prague | Czech Girls Mausseuses',
        'meta-keywords' => 'See our photo gallery.',
        'meta-description' => 'Our photo gallery masseuses Larosa.cz',
    ],
    ...
    'erotic_massage' => [
        ...
        'meta-description' => 'Ours erotic massage in Prague is an excellent way to combat stress and mental health problems.  Will clear your spirit and body. Contact us.',
    ],
